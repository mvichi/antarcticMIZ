...
OSIclim=ds.sigmaSIAclim.where(ds.sigmaSIAclim>0.)
...
DIR='/mnt/d/SEAICE/ESA/ESACCI-SEAICE-CDR/'
df=DIR+'ice_conc_sh_dayanom_monstd_ease2-250_cdr-v2p0_1979-2014.nc'
...
q = anom.ice_conc.where(anom.ice_conc>0.).median(dim='time')/100. # convert to fraction
